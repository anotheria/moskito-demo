...
public interface ICommentsPersistenceService{
	 ...
	 */
    void deleteComment(String id) throws CommentsPersistenceServiceException;
	 ...
	 */
    Comment getComment(String id) throws CommentsPersistenceServiceException;
	 ...
	 */
    List<Comment> getCommentsByProperty(QueryProperty... properties) throws CommentsPersistenceServiceException;
	 ...
	 */
    List<Comment> getComments(Segment aSegment) throws CommentsPersistenceServiceException;

	/**
	 * Returns Comment objects segment which match the given property or properties.
	 */
    List<Comment> getCommentsByProperty(Segment aSegment, QueryProperty... properties) throws CommentsPersistenceServiceException;
