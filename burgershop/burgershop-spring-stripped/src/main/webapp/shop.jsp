...
<table cellpadding="0" cellspacing="0">
    <tbody>
    <tr>
        <ano:iterate name="BREAD" id="bread" type="org.moskito.demo.burgershop.burgershopstripped.ui.ShopItemBean">
    ...
    <tr>
        <ano:iterate name="MEAT" id="meat" type="org.moskito.demo.burgershop.burgershopstripped.ui.ShopItemBean">
    ...
    <tr>
        <ano:iterate name="EXTRAS" id="extra" type="org.moskito.demo.burgershop.burgershopstripped.ui.ShopItemBean">
